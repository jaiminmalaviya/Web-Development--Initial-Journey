...
// Default values
const { menu = 5, starterMenu: starters = [] } = restaurant;
console.log(menu, starters);

// Mutating variables
let aa = 111;
let bb = 999;
const obj = { aa: '23h', bb: 7, cc: 14 };
({ aa, bb } = obj);
console.log(aa, bb);
...
// Objects
// const { sat, ...weekdayss } = restaurant.mainMenu;
// console.log((weekdayss[0] = 7));
...
console.log(users?.[0]?.id ?? 'User array empty');
